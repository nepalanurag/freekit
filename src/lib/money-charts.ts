...
export function trendLegend(): string {
  return `<div class="chart-legend"><span><span class="swatch swatch-solid"></span>Income</span><span><span class="swatch swatch-dashed"></span>Spent</span></div>`;
}

/** Legend for the budget category bars: tick = planned, bar = actual, red = over. */
export function categoryLegend(): string {
  return `<div class="chart-legend"><span><span class="swatch swatch-tick"></span>Planned</span><span><span class="swatch swatch-actual"></span>Actual</span><span><span class="swatch swatch-over"></span>Over budget</span></div>`;
}
